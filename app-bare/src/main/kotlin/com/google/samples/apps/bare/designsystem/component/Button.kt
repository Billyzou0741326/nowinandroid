...
fun BareAppOutlinedButton(
    ...
    OutlinedButton(
        ...
        border = BorderStroke(
            width = BareAppButtonDefaults.OutlinedButtonBorderWidth,
            color = if (enabled) {
                MaterialTheme.colorScheme.outline
            } else {
                MaterialTheme.colorScheme.onSurface.copy(
                    alpha = BareAppButtonDefaults.DISABLED_OUTLINED_BUTTON_BORDER_ALPHA,
                )
            },
        ),
        contentPadding = contentPadding,
 ...
 */
@Composable
private fun BareAppButtonContent(
    text: @Composable () -> Unit,
    leadingIcon: @Composable (() -> Unit)? = null,
) {
    if (leadingIcon != null) {
...
@ThemePreviews
@Composable
fun BareButtonPreview() {
    BareAppTheme {
        BareBackground(modifier = Modifier.size(150.dp, 50.dp)) {
            BareAppButton(onClick = {}, text = { Text("Test button") })
        }
    }
}
...
@ThemePreviews
@Composable
fun BareOutlinedButtonPreview() {
    BareAppTheme {
        BareBackground(modifier = Modifier.size(150.dp, 50.dp)) {
            BareAppOutlinedButton(onClick = {}, text = { Text("Test button") })
        }
    }
}
...
@ThemePreviews
@Composable
fun BareButtonLeadingIconPreview() {
    BareAppTheme {
        BareBackground(modifier = Modifier.size(150.dp, 50.dp)) {
            BareAppButton(
                onClick = {},
